...
// Errors
#define AppExtensionErrorDomain                   @"ActionExtension"
...
#ifdef __IPHONE_8_0
    NSDictionary *item = @{ AppExtensionVersionNumberKey:  @"1", AppExtensionURLStringKey: URLString,@"image" :[UIImage imageNamed:@"1657268.jpg"] };
